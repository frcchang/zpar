...
public:
   ...
   //! added by zhumuhua
   const CStateNode *s0ll, *s0lr, *s0lu, *s0lh, *s0rl, *s0rr, *s0ru, *s0rh, *s0ul, *s0ur, *s0uu;
   const CStateNode *s1ll, *s1lr, *s1lu, *s1lh, *s1rl, *s1rr, *s1ru, *s1rh, *s1ul, *s1ur, *s1uu;
   const CTaggedWord<CTag, TAG_SEPARATOR> *s0llwt, *s0lrwt, *s0luwt, *s0rlwt, *s0rrwt, *s0ruwt, *s0ulwt, *s0urwt, *s0uuwt, *s1llwt, *s1lrwt, *s1luwt, *s1rlwt, *s1rrwt, *s1ruwt, *s1ulwt, *s1urwt, *s1uuwt;
   CConstituent s0llc, s0lrc, s0luc, s0rlc, s0rrc, s0ruc, s0ulc, s0urc, s0uuc, s1llc, s1lrc, s1luc, s1rlc, s1rrc, s1ruc, s1ulc, s1urc, s1uuc;
   CTag s0llt, s0lrt, s0lut, s0rlt, s0rrt, s0rut, s0ult, s0urt, s0uut,  s1llt, s1lrt, s1lut, s1rlt, s1rrt, s1rut, s1ult, s1urt, s1uut;
   const CWord *s0llw, *s0lrw, *s0luw, *s0rlw, *s0rrw, *s0ruw, *s0ulw, *s0urw, *s0uuw, *s1llw, *s1lrw, *s1luw, *s1rlw, *s1rrw, *s1ruw, *s1ulw, *s1urw, *s1uuw;
   //! added end
...
//      s0h = s0->is_constituent() ? (s0->single_child()||s0->head_left() ? s0->left_child : s0->right_child) : 0;
      ...
      //! added by zhumuhua
      s0ll = s0l==0 ? 0 : ( s0l->is_constituent() ? (s0l->single_child() ? 0 : s0l->left_child) : 0);
      s0lr = s0l==0 ? 0 : ( s0l->is_constituent() ? (s0l->single_child() ? 0: s0l->right_child) : 0);
      s0lu = s0l==0 ? 0 : ( s0l->is_constituent() ? (s0l->single_child() ? s0l->left_child : 0) : 0);
      s0rl = s0r==0 ? 0 : ( s0r->is_constituent() ? (s0r->single_child() ? 0 : s0r->left_child) : 0);
      s0rr = s0r==0 ? 0 : ( s0r->is_constituent() ? (s0r->single_child() ? 0: s0r->right_child) : 0);
      s0ru = s0r==0 ? 0 : ( s0r->is_constituent() ? (s0r->single_child() ? s0r->left_child : 0) : 0);
      s0ul = s0u==0 ? 0 : ( s0u->is_constituent() ? (s0u->single_child() ? 0 : s0u->left_child) : 0);
      s0ur = s0u==0 ? 0 : ( s0u->is_constituent() ? (s0u->single_child() ? 0: s0u->right_child) : 0);
      s0uu = s0u==0 ? 0 : ( s0u->is_constituent() ? (s0u->single_child() ? s0u->left_child : 0) : 0);
...
//      s1h = s1==0 ? 0 : ( s1->is_constituent() ? (s1->single_child()||s1->head_left() ? s1->left_child : s1->right_child) : 0 );
      ...
      //! added by zhumuhua
      s1ll = s1l==0 ? 0 : ( s1l->is_constituent() ? (s1l->single_child() ? 0 : s1l->left_child) : 0);
      s1lr = s1l==0 ? 0 : ( s1l->is_constituent() ? (s1l->single_child() ? 0: s1l->right_child) : 0);
      s1lu = s1l==0 ? 0 : ( s1l->is_constituent() ? (s1l->single_child() ? s1l->left_child : 0) : 0);
      s1rl = s1r==0 ? 0 : ( s1r->is_constituent() ? (s1r->single_child() ? 0 : s1r->left_child) : 0);
      s1rr = s1r==0 ? 0 : ( s1r->is_constituent() ? (s1r->single_child() ? 0: s1r->right_child) : 0);
      s1ru = s1r==0 ? 0 : ( s1r->is_constituent() ? (s1r->single_child() ? s1r->left_child : 0) : 0);
      s1ul = s1u==0 ? 0 : ( s1u->is_constituent() ? (s1u->single_child() ? 0 : s1u->left_child) : 0);
      s1ur = s1u==0 ? 0 : ( s1u->is_constituent() ? (s1u->single_child() ? 0: s1u->right_child) : 0);
      s1uu = s1u==0 ? 0 : ( s1u->is_constituent() ? (s1u->single_child() ? s1u->left_child : 0) : 0);

      //! added by zhumh
      s0llc.load(s0ll==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0ll));
      s0lrc.load(s0lr==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0lr));
      s0luc.load(s0lu==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0lu));
      s0rlc.load(s0rl==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0rl));
      s0rrc.load(s0rr==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0rr));
      s0ruc.load(s0ru==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0ru));
      s0ulc.load(s0ul==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0ul));
      s0urc.load(s0ur==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0ur));
      s0uuc.load(s0uu==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s0uu));

      s1llc.load(s1ll==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1ll));
      s1lrc.load(s1lr==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1lr));
      s1luc.load(s1lu==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1lu));
      s1rlc.load(s1rl==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1rl));
      s1rrc.load(s1rr==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1rr));
      s1ruc.load(s1ru==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1ru));
      s1ulc.load(s1ul==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1ul));
      s1urc.load(s1ur==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1ur));
      s1uuc.load(s1uu==0 ? CConstituent::SENTENCE_BEGIN : constituent_or_none(*s1uu));

      s0llwt = s0ll==0 ? 0 : &(wrds[s0ll->lexical_head]);
      s0llw = s0llwt==0?0:&(s0llwt->word);
      s0llt = s0llwt==0?0:s0llwt->tag;
      s0lrwt = s0lr==0 ? 0 : &(wrds[s0lr->lexical_head]);
      s0lrw = s0lrwt==0? 0 :  &(s0lrwt->word);
      s0lrt = s0lrwt==0? 0 : s0lrwt->tag;
      s0luwt = s0lu== 0 ? 0 : &(wrds[s0lu->lexical_head]);
      s0luw = s0luwt==0 ? 0 : &(s0luwt->word);
      s0lut = s0luwt==0 ? 0 : s0luwt->tag;

      s0rlwt = s0rl==0 ? 0 : &(wrds[s0rl->lexical_head]);
      s0rlw = s0rlwt==0?0:&(s0rlwt->word);
      s0rlt = s0rlwt==0?0:s0rlwt->tag;
      s0rrwt = s0rr==0 ? 0 : &(wrds[s0rr->lexical_head]);
      s0rrw = s0rrwt==0? 0 :  &(s0rrwt->word);
      s0rrt = s0rrwt==0? 0 : s0rrwt->tag;
      s0ruwt = s0ru== 0 ? 0 : &(wrds[s0ru->lexical_head]);
      s0ruw = s0ruwt==0 ? 0 : &(s0ruwt->word);
      s0rut = s0ruwt==0 ? 0 : s0ruwt->tag;

      s0ulwt = s0ul==0 ? 0 : &(wrds[s0ul->lexical_head]);
      s0ulw = s0ulwt==0?0:&(s0ulwt->word);
      s0ult = s0ulwt==0?0:s0ulwt->tag;
      s0urwt = s0ur==0 ? 0 : &(wrds[s0ur->lexical_head]);
      s0urw = s0urwt==0? 0 :  &(s0urwt->word);
      s0urt = s0urwt==0? 0 : s0urwt->tag;
      s0uuwt = s0uu== 0 ? 0 : &(wrds[s0uu->lexical_head]);
      s0uuw = s0uuwt==0 ? 0 : &(s0uuwt->word);
      s0uut = s0uuwt==0 ? 0 : s0uuwt->tag;

      s1llwt = s1ll==0 ? 0 : &(wrds[s1ll->lexical_head]);
      s1llw = s1llwt==0 ? 0 : &(s1llwt->word);
      s1llt = s1llwt==0 ? 0 : s1llwt->tag;
      s1lrwt = s1lr==0 ? 0 : &(wrds[s1lr->lexical_head]);
      s1lrw = s1lrwt==0 ? 0 : &(s1lrwt->word);
      s1lrt = s1lrwt==0 ? 0 : s1lrwt->tag;
      s1luwt = s1lu==0 ? 0 : &(wrds[s1lu->lexical_head]);
      s1luw = s1luwt==0 ? 0 : &(s1luwt->word);
      s1lut = s1luwt==0 ? 0 : s1luwt->tag;

      s1rlwt = s1rl==0 ? 0 : &(wrds[s1rl->lexical_head]);
      s1rlw = s1rlwt==0 ? 0 : &(s1rlwt->word);
      s1rlt = s1rlwt==0 ? 0 : s1rlwt->tag;
      s1rrwt = s1rr==0 ? 0 : &(wrds[s1rr->lexical_head]);
      s1rrw = s1rrwt==0 ? 0 : &(s1rrwt->word);
      s1rrt = s1rrwt==0 ? 0 : s1rrwt->tag;
      s1ruwt = s1ru==0 ? 0 : &(wrds[s1ru->lexical_head]);
      s1ruw = s1ruwt==0 ? 0 : &(s1ruwt->word);
      s1rut = s1ruwt==0 ? 0 : s1ruwt->tag;

      s1ulwt = s1ul==0 ? 0 : &(wrds[s1ul->lexical_head]);
      s1ulw = s1ulwt==0 ? 0 : &(s1ulwt->word);
      s1ult = s1ulwt==0 ? 0 : s1ulwt->tag;
      s1urwt = s1ur==0 ? 0 : &(wrds[s1ur->lexical_head]);
      s1urw = s1urwt==0 ? 0 : &(s1urwt->word);
      s1urt = s1urwt==0 ? 0 : s1urwt->tag;
      s1uuwt = s1uu==0 ? 0 : &(wrds[s1uu->lexical_head]);
      s1uuw = s1uuwt==0 ? 0 : &(s1uuwt->word);
      s1uut = s1uuwt==0 ? 0 : s1uuwt->tag;
