...
#define iterate_templates(left, right) do {\
  ...
  left(S0m2_p)right;          /* 17 */ \
  left(S0m1_p)right;          /* 18 */ \
  left(S0p1_p)right;          /* 19 */ \
  left(S0p2_p)right;          /* 20 */ \
  left(N0m1_p)right;          /* 21 */ \
  left(N0p1_p)right;          /* 22 */ \
  left(N0p1_p_S0_p)right;     /* 23 */ \
  left(Sm1_p_S0_p)right;      /* 24 */ \
  left(Sm1_p_N0_p)right;      /* 25 */ \
  ...
  left(S0m2_p_S0m1_p_S0_p)right;  /* 33 */ \
  left(S0m1_p_S0p1_p_S0_p)right;  /* 34 */ \
  left(S0p1_p_S0p2_p_S0_p)right;  /* 35 */ \
  left(N0m1_p_N0p1_p_N0_p)right;  /* 36 */ \
  left(N0p1_p_N0p2_p_N0_p)right;  /* 37 */ \
  left(Sm2_p_Sm1_p_S0_p)right;    /* 38 */ \
  left(Sm2_p_S0_p_N0_p)right;     /* 39 */ \
  left(S0m1_p_S0_p_N0_p)right;    /* 40 */ \
  left(S0p1_p_S0_p_N0_p)right;    /* 41 */ \
  left(N0m2_p_S0_p_N0_p)right;    /* 42 */ \
  left(N0m1_p_S0_p_N0_p)right;    /* 43 */ \
  left(N0p1_p_S0_p_N0_p)right;    /* 44 */ \
  left(N0p2_p_S0_p_N0_p)right;    /* 45 */ \
  left(N0p3_p_S0_p_N0_p)right;    /* 46 */ \
  left(Sm3_p_S0_p_N0_p)right;     /* 47 */ \
  left(S0h_w)right;               /* 48 */ \
  ...
  left(S0h_p)right;               /* 53 */ \
  left(S0lm_p)right;              /* 54 */ \
  left(S0rm_p)right;              /* 55 */ \
  left(N0h_p)right;               /* 56 */ \
  left(N0lm_p)right;              /* 57 */ \
  left(S0h_d)right;               /* 58 */ \
  left(S0lm_d)right;              /* 59 */ \
  left(S0rm_d)right;              /* 60 */ \
  left(N0h_d)right;               /* 61 */ \
  left(N0lm_d)right;              /* 62 */ \
  left(S0lm_p_S0_p_N0_p)right;    /* 63 */ \
  left(S0rm_p_S0_p_N0_p)right;    /* 64 */ \
  left(S0h_p_S0_p_N0_p)right;     /* 65 */ \
  left(N0lm_p_S0_p_N0_p)right;    /* 66 */ \
  left(N0h_p_S0_p_N0_p)right;     /* 67 */ \
  left(S0h2_w)right;              /* 68 */ \
  left(S0lm2_w)right;             /* 69 */ \
  left(S0rm2_w)right;             /* 70 */ \
  left(N0h2_w)right;              /* 71 */ \
  left(N0lm2_w)right;             /* 72 */ \
  left(S0h2_p)right;              /* 73 */ \
  left(S0lm2_p)right;             /* 74 */ \
  left(S0rm2_p)right;             /* 75 */ \
  left(N0h2_p)right;              /* 76 */ \
  left(N0lm2_p)right;             /* 77 */ \
  left(S0h2_d)right;              /* 78 */ \
  left(S0lm2_d)right;             /* 79 */ \
  left(S0rm2_d)right;             /* 80 */ \
  left(N0h2_d)right;              /* 81 */ \
  left(N0lm2_d)right;             /* 82 */ \
  left(S0lm2_p_S0lm_p_S0_p)right; /* 83 */ \
  left(S0rm2_p_S0rm_p_S0_p)right; /* 84 */ \
  left(N0lm2_p_N0lm_p_N0_p)right; /* 85 */ \
  left(S0h2_p_S0h_p_S0_p)right;   /* 86 */ \
  left(N0h2_p_N0h_p_N0_p)right;   /* 87 */ \
  left(S0lm2_p_S0_p_N0_p)right;   /* 88 */ \
  left(S0rm2_p_S0_p_N0_p)right;   /* 89 */ \
