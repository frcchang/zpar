...
public:
   ...
   const static unsigned long m_mlh=2 ; // mask for left neighbour being the head word of current word
   const static unsigned long m_mrh=1 ; 
   const static unsigned long limit=4;

   const static unsigned long begin=3;
