...
\\
Both input and output files must be encoded in \textit{utf8}. Here is a \href{jont_files/gb2utf.py}{script} that transfers files that are encoded in \textit{gb} to the \textit{utf8} encoding.
...
Yue Zhang and Stephen Clark. 2008. Joint Word Segmentation and POS Tagging Using A Single Perceptron. In {\em Proc. of ACL} 2007. pages 888-896.
%\bibitem{bib-2}
